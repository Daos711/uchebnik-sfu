...
Для радиальной и возвратно-поступательной пар давление
...
\caption{Компоненты гидродинамической силы на валу}
...
Возвратно-поступательная пара -- мгновенные расходы через
...
Сила трения для возвратно-поступательной пары:
\begin{equation}
