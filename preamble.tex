% =============================================================
% preamble.tex — Преамбула учебного пособия (СТУ 7.5–07–2021 СФУ)
% =============================================================
...
% Высокий штраф запрещает переносить последнюю/первую строку абзаца
% на отдельную страницу (напр. «2 слова на всю страницу»).
% Совместимо с \raggedbottom: страница может стать короче, но без висячих строк.
\widowpenalty=10000
\clubpenalty=10000
...
\titleformat{\chapter}[block]
  {\normalfont\normalsize\bfseries}
  {\hspace*{1.25cm}\thechapter}{0.25em}{}
...
\titleformat{\section}[block]
  {\normalfont\normalsize\bfseries}
  {\hspace*{1.25cm}\thesection}{0.25em}{}
...
\titleformat{\subsection}[block]
  {\normalfont\normalsize\bfseries}
  {\hspace*{1.25cm}\thesubsection}{0.25em}{}
